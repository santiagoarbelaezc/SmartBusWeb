      ...
      <div class="flex-1 overflow-y-auto p-6">
        <div class="flex flex-col gap-4">
          <div class="bg-white rounded-[20px] p-5 shadow-sm flex gap-4 opacity-70">
            <div class="w-10 h-10 bg-brand-gold/20 rounded-full flex items-center justify-center shrink-0">
              <span class="material-icons text-brand-gold">directions_bus</span>
            </div>
          ...
          <div class="bg-white rounded-[20px] p-5 shadow-sm flex gap-4">
            ...
            <div class="flex flex-col relative w-full">
              <div class="w-2 h-2 bg-brand-gold rounded-full absolute -right-1 top-1"></div>
