  ...
  template: `
    <div class="w-full h-full bg-[#F5F6F8] flex flex-col overflow-hidden">
      ...
      <div class="flex-1 overflow-y-auto p-6 flex flex-col items-center">
        <div class="w-20 h-20 bg-brand-gold/20 rounded-full flex items-center justify-center mb-4">
           <span class="material-icons text-brand-gold text-4xl">account_balance_wallet</span>
        </div>
