  ...
  template: `
    <div class="w-full h-full bg-white flex flex-col overflow-hidden">
      ...
      <div class="flex-1 overflow-y-auto p-6 flex flex-col items-center">
        <div class="w-20 h-20 bg-brand-primary/20 rounded-full flex items-center justify-center mb-4">
           <span class="material-icons text-brand-primary text-4xl">account_balance_wallet</span>
        </div>
